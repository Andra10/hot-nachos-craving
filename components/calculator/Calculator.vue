<template>
  <v-row>
    ...
    >
      ...
      color: ffdf00
            @click="clear"
            >{{ $t('calculator.form.clear') }}</ButtonNachos
          >
          <ButtonNachos
      ...
      color="yellow accent-2"
            @click="submit"
            >{{ $t('calculator.form.submit') }}</ButtonNachos
          >
        </div>
      </form>
      ...
      color="yellow accent-2"
          @click="clear"
          >{{ $t('calculator.form.restart') }}</ButtonNachos
        >
      </div>
    </v-col>
  </v-row>
...
import LoadingNachos from '@/components/LoadingNachos';
